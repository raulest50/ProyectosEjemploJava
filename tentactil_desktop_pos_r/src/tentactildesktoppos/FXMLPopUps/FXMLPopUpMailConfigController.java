...
public class FXMLPopUpMailConfigController extends ControllerFather {
    ...
    public void onClickDynPass(MouseEvent event) {
        try{
            ...
            String[] destino = {TF_DestinoMail.getText()};
            
            // se envia un correo con los
            hndconf.EnviarTextEmail(TF_SenderMail.getText(), TF_Pass.getText(),
                    destino, "Tentactil DynPassTest", hndconf.getConfiguracion(SQL_Configuracion.PRT_DYN_PASS));
